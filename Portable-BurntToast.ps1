...
if ($WinMajorVersion -ge 10) {
    ...
    $Script:Config = '{"AppId":  "{1AC14E77-02E7-4E5D-B744-2EB1AE5198B7}\\WindowsPowerShell\\v1.0\\powershell.exe","AppLogo":  "https://github.com/Windos/BurntToast/raw/main/BurntToast/Images/BurntToast.png"}' | ConvertFrom-Json
